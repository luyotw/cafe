...
steps:
  source:
    role: operator
    skill: source
    behavior: {feedback_target: receiver, feedback_artifact: workflow_feedback, feedback_source_kind: github_pr, feedback_todo_source: pr_comment}
  ...
  fixed-review:
    ...
    human_tasks:
      - trigger: confirm_output
        ...
        feedback_delivery: {artifact: workflow_feedback, source_kind: local_review, todo_source: workflow_feedback}
