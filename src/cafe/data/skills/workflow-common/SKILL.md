...
3. Read the runtime-provided baton path only if you need to hand off explicitly at the end of this phase.
...
- When you explicitly hand off to another phase in the current run, write only that phase name into the runtime-provided next-step file.
