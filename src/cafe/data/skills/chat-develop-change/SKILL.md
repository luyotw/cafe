---
name: chat-develop-change
description: "Handle implementation changes discussed directly inside cafe chat"
version: 1.0.0
---
...
## Use This Skill When
- The user asks for code changes during chat.
- The change may be small or large.
- The work may be completed directly during chat.
